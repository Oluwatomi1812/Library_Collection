...
router.get("/findAllUsers", UserControllers.listAllUsers)
...
router.get("/findAllBooks", LibraryController.listAllBooks)
...
router.get("/getAllRentals", RentalControllers.getAllRentals)
